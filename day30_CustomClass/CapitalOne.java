...
public class CapitalOne {
    public static void main(String[] args) {
        ...
        employee5.setInfo("Kevin", 'M', 35, 2298, "QA", 110000, true);
        ...
        ArrayList<Integer> emplSalary = new ArrayList<>();
        for (Employee each : employees) {
            emplSalary.add(each.salary);
        }
        int maximum = Collections.max(emplSalary);
        System.out.println("maximum = " + maximum);
        System.out.println("minimum " +Collections.min(emplSalary));
    }
}
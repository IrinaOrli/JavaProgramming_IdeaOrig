...
public class HTTPStatusCode {
    ...
    Some of the codes and their meanings are listed below:
        ...
        int statusCode = 700;
        String meaning ="";
        meaning = (statusCode ==200)? "OK": (statusCode==201)? "Created": (statusCode==202)? "Accepted": (statusCode == 301)?
                ...
                "Internal Server Error": (statusCode==503)?"Service Unavailable": "Unknown status code";
